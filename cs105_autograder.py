...
username = "newsletter2020junk@gmail.com"
...
# MAGIC %pip install --upgrade autograder
# MAGIC import autograder
# MAGIC autograder.guide
# MAGIC try:
# MAGIC   print("Your private token is " + private_token)
# MAGIC except NameError:
# MAGIC   print(signup.signup(username))

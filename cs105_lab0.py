...
dataDF = sqlContext.read.text('/databricks-datasets/cs100/lab1/data-001/shakespeare.txt')
...
# MAGIC %pip install databricks_test_helper
# MAGIC # TEST Compare with hash (2a)
# MAGIC # Check our testing library/package
# MAGIC # This should print '1 test passed.' on two lines
# MAGIC from databricks_test_helper import Test
# MAGIC
# MAGIC twelve = 12
# MAGIC Test.assertEquals(twelve, 12, 'twelve should equal 12')
# MAGIC Test.assertEqualsHashed(twelve, '7b52009b64fd0a2a49e6d8a939753077792b0554',
# MAGIC                         'twelve, once hashed, should equal the hashed value of 12')
